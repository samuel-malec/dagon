...
namespace qthu::ct2qjs {
    void codegen::emit_fn_join(const lowered_insn &insn) {
        ...
        builder.add_instr(as::is_undefined_());
        builder.add_instr(as::if_true_(else_label));
        builder.add_instr(as::get_loc_(insn.slots_in[0]));
        builder.add_instr(as::goto_(endif_label));

        builder.add_label(else_label);
        builder.add_instr(as::get_loc_(insn.slots_in[1]));
        builder.add_instr(as::is_undefined_());
        builder.add_instr(as::if_false_(check_label));
        builder.add_instr(as::throw_());
    ...
    void codegen::emit_fn_opt(const lowered_insn &insn) {
        ...
        builder.add_instr(as::get_loc_(insn.slots_in[0]));
        builder.add_instr(as::if_true_(then_label));

        builder.add_instr(as::undefined_());
        builder.add_instr(as::put_loc_(insn.slots_out[0]));
        builder.add_instr(as::goto_(end_label));
    ...
    void codegen::emit_builtin(const lowered_insn &insn, uint32_t uid) {
        ...
        if (name == "qjs_val_pop") {
            builder.add_instr(as::get_loc_(insn.slots_in[0]));
            builder.add_instr(as::get_length_());
            builder.add_instr(as::push_i32_(1));
            builder.add_instr(as::sub_());
            builder.add_instr(as::get_loc_(insn.slots_in[0]));
            builder.add_instr(as::swap_());
            builder.add_instr(as::get_array_el_());
        ...
        if (name == "qjs_val_add") {
            binary_insn(insn, as::add_());
            return;
        }

        if (name == "qjs_val_sub") {
            binary_insn(insn, as::sub_());
            return;
        }
        ...
        if (name == "qjs_val_div") {
            binary_insn(insn, as::div_());
            return;
        }

        if (name == "qjs_val_rem") {
            binary_insn(insn, as::mod_());
            return;
        }

        if (name == "qjs_val_eq") {
            binary_insn(insn, as::eq_());
            return;
        }

        if (name == "qjs_val_ne") {
            binary_insn(insn, as::neq_());
            return;
        }
        ...
        if (name == "qjs_val_le") {
            binary_insn(insn, as::lte_());
            return;
        }

        if (name == "qjs_val_ge") {
            binary_insn(insn, as::gte_());
            return;
        }

        if (name == "qjs_val_gt") {
            binary_insn(insn, as::gt_());
            return;
        }

        if (name == "qjs_val_ashl") {
            get2(insn);
            builder.add_instr(as::shl_());
            builder.add_instr(as::put_loc_(insn.slots_out[0]));
            return;
        }
        ...
        if (name == "qjs_val_ashr") {
            get2(insn);
            builder.add_instr(as::shr_());
            builder.add_instr(as::put_loc_(insn.slots_out[0]));
            return;
        }

        if (name == "qjs_val_cons_obj") {
            builder.add_instr(as::object_());
            builder.add_instr(as::put_loc_(insn.slots_out[0]));
            return;
        }

        if (name == "qjs_val_cons_arr") {
            builder.add_instr(as::array_from_(0));
            builder.add_instr(as::put_loc_(insn.slots_out[0]));
            return;
        }
        ...
        if (name == "qjs_val_set") {
            ...
            builder.add_instr(as::dup_());
            builder.add_instr(as::get_loc_(insn.slots_in[1]));
            builder.add_instr(as::get_loc_(insn.slots_in[2]));
            builder.add_instr(as::put_array_el_());
            builder.add_instr(as::put_loc_(insn.slots_out[0]));
            return;
        }
        ...
        if (name.starts_with("qjs_val_cons_")) {
            ...
            if (suffix == "true") {
                builder.add_instr(as::push_true_());
                builder.add_instr(as::put_loc_(insn.slots_out[0]));
                return;
            }
        ...
        if (name == "qjs_val_bnot") {
            get1(insn);
            builder.add_instr(as::not_());
            builder.add_instr(as::put_loc_(insn.slots_out[0]));
            return;
        }

        if (name == "qjs_val_and") {
            binary_insn(insn, as::and_());
            return;
        }

        if (name == "qjs_val_or") {
            binary_insn(insn, as::or_());
            return;
        }

        if (name == "qjs_val_xor") {
            binary_insn(insn, as::xor_());
            return;
        }
        ...
        if (name == "qjs_val_assert") {
            ...
            get1(insn);
            builder.add_instr(as::if_true_(label));
            builder.add_instr(as::throw_());
